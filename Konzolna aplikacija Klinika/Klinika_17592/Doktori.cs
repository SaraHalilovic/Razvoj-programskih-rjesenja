...
{
    class Doktori:Uposlenici
    {
        private Odjel odjel_doktora17592;
        private double dodatakNaPlatu_doktora17592;
        private int brojPacijenata_doktora17592;
        
        public Doktori(int plata, String ime, String prezime,String adresa, String jmbg, DateTime datum_rodjenja, double dodatak, int pac) : base ( ime, prezime,adresa, jmbg, datum_rodjenja,plata){
